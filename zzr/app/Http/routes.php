...
//	Route::post('file','forms\FormController@store');
...
//
////stu学生信息管理系统
//Route::group(['prefix'=>'stus'],function(){
//	Route::get('/','StusController@index');
//	Route::get('add','StusController@add');
//	Route::post('insert','StusController@insert');
//	Route::get('del/{id}','Stus\StusController@destroy');
//	Route::get('find/{id}','Stus\StusController@find');
//
//});